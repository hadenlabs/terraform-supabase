...
// TestExampleBasicUsage demonstrates basic usage of the Project struct
func TestExampleBasicUsage(t *testing.T) {
	...
	// Customize the organization ID - returns a new instance
...
// TestProjectIntegrationExample demonstrates real test using the supabase package
...
func TestEdgeCases(t *testing.T) {
	...
	project := NewProject().WithOrganizationID("")
	...
	specialProject := NewProject().WithOrganizationID("org-name_with.mixed-chars123")
