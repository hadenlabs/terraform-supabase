...
<!-- Title: Contributing GithubFlow TerraformSupaBase -->
...
To contribute to terraform-supabase project on [GitHub](https://github.com/hadenlabs/terraform-supabase), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/terraform-supabase/pulls).
...
To follow the instructions in this guide and start contributing to terraform-supabase project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/terraform-supabase.git
```

Now your **upstream** points to **hadenlabs/terraform-supabase**.
...
git fetch upstream # assuming upstream is hadenlabs/terraform-supabase
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/terraform-supabase/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
